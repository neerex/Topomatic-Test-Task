    ...
    public static class TriangulateConvexHull
    {
        ...
        public static HashSet<Triangle2> GetTriangles(List<MyVector2> pointsOnHull, bool addColinearPoints)
        {
            ...
            for (int i = 1; i < pointsOnHull.Count; i++)
            {
                ...
                LeftOnRight pointRelation = GeometryUtility.IsPoint_Left_On_Right_OfVector(a, b, c);
        ...
        private static void SplitTriangleEdge(Triangle2 t, MyVector2 p, HashSet<Triangle2> triangles)
        {
            ...
            if (GeometryUtility.IsPoint_Left_On_Right_OfVector(a, b, p) == LeftOnRight.On)
            {
            ...
            else if (GeometryUtility.IsPoint_Left_On_Right_OfVector(b, c, p) == LeftOnRight.On)
            {
            ...
            else if (GeometryUtility.IsPoint_Left_On_Right_OfVector(c, a, p) == LeftOnRight.On)
            {
